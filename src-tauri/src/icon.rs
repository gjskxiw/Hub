...
/// 应用自身的图标：同一图形的两个色版，随界面主题切换（浅色主题用近黑，深色主题用纯白）。
/// 打包进 exe 的那张（资源管理器里看到的）跟不了主题，固定用 dark.png 生成。
pub const ICON_BLACK: &[u8] = include_bytes!("../../dark.png");
pub const ICON_WHITE: &[u8] = include_bytes!("../../light.png");
